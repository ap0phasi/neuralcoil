...
This vignette will demonstrate some of the properties of probablistic coils as well as explore potential applications. For an overview of the motivation, theory, and derivation of coils please see <insert_link>
...
When visualizing the complex coil values, we can see that conservation is maintained if the complex coil values for each state at a given time add up to equal some point along the complex unit circle. 
...
for (itt in 1:Tlen){
  ...
  legend("topright",col=c("red","blue"),c("Real","Imaginary"),lty=1,lwd=2)
}
