...
We will begin this exercise with a joke: a universe will be constructed that only consists of two things: the price movement of the SPY stock and *not* the price movement of SPY stock. While this is humorous, it is not an ontologically incorrect way of describing reality - perhaps just not a helpful one. 
...
Here we can see that even though these different coil dynamics start nearly identically, they quickly diverege from one another into completely different solutions. This extreme sensitivity also demonstrates why coils are so difficult to train. While coils may not et be able to forecast stock price, it is encouraging that they exhibit the same unpredictability and chaos as the systems they are intended to represent. 
